...
if (isset ($_POST['firstname'])  && isset ($_POST['lastname'])  && isset ($_POST['username'])  && isset($_POST['email']) && isset ($_POST['password'])  && isset ($_POST['confirmpassword']) && isset ($_POST['gender'])  && isset ($_POST['mobilenumber'])   ) {
  ...
  $sql = 'UPDATE tbl_admin SET A_firstname =:firstname, A_lastname =:lastname, A_username=:username, A_email=:email, A_password =:password, A_confirmpassword=:confirmpassword, A_gender=:gender, A_mobilenumber=:mobilenumber WHERE A_id=:id';
  
  $statement = $connection->prepare($sql);
  
  if ($statement->execute([':firstname' => $firstname,':lastname' => $lastname,':username' => $username, ':email' => $email,':password' => $password,':confirmpassword' => $confirmpassword, ':gender' => $gender, ':mobilenumber' => $mobilenumber, ':id' => $id]  )) 
  {
          ...
          <form method="post" class="needs-validation" novalidate>
              ...
              <div class="form-row">
                <div class="col-md-6 col-lg-6" style="padding: 1%;">
                  ...
                  <div class="input-group">
                    <input value="<?= $user->A_firstname; ?>" type="text" class="form-control" id="validationCustomFirstname" name="firstname" placeholder="Firstname" aria-describedby="inputGroupPrepend" required>
                ...
                <div class="col-md-6 col-lg-6" style="padding: 1%;">
                  ...
                  <div class="input-group">
                    <input value="<?= $user->A_lastname; ?>" type="text" class="form-control" id="validationCustomLastname" name="lastname" placeholder="Lastname" aria-describedby="inputGroupPrepend" required>
                    <div class="invalid-feedback">
              ...
              <div class="form-row">
                ...
                <div class="col-md-6 col-lg-6" style="padding: 1%;">
                    ...
                    <div class="input-group">
                      <input value="<?= $user->A_email; ?>" type="text" class="form-control" id="validationCustomEmail" name="email" placeholder="Email" aria-describedby="inputGroupPrepend" required>
                      <div class="invalid-feedback">
              ...
              <div class="form-row">
                <div class="col-md-6 col-lg-6" style="padding: 1%;">
                    ...
                    <div class="input-group">
                      <input value="<?= $user->A_password; ?>" type="text" class="form-control" id="validationCustomPassword" name="password" placeholder="Password" aria-describedby="inputGroupPrepend" required>
                      <div class="invalid-feedback">
                ...
                <div class="col-md-6 col-lg-6" style="padding: 1%;">
                    ...
                    <div class="input-group">
                      <input value="<?= $user->A_confirmpassword; ?>" type="text" class="form-control" id="validationCustomconfirmpassword" name="confirmpassword" placeholder="Confirm Password" aria-describedby="inputGroupPrepend" required>
                      <div class="invalid-feedback">
              ...
              <div class="form-row">
                <div class="col-md-6 col-lg-6" style="padding: 1%;">
                    ...
                    <div class="input-group">
                      <input value="<?= $user->A_gender; ?>" type="text" class="form-control" id="validationCustomGender" name="gender" placeholder="Gender" aria-describedby="inputGroupPrepend" required>
                      <div class="invalid-feedback">
                ...
                <div class="col-md-6 col-lg-6" style="padding: 1%;">
                    ...
                    <div class="input-group">
                      <input value="<?= $user->A_mobilenumber; ?>" type="text" class="form-control" id="validationCustomMobile" name="mobilenumber" placeholder="Mobile" aria-describedby="inputGroupPrepend" required>
                      <div class="invalid-feedback">
