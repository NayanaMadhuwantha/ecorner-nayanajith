          ...
          <form method="post" class="needs-validation" novalidate>
            ...
            <div class="form-row">
              <div class="col-md-6 col-lg-6" style="padding: 1%;">
                ...
                <div class="input-group">
                  <input value="<?= $person->U_username; ?>" type="text" class="form-control" pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{5,20}$" id="validationCustomUsername" name="username" placeholder="Username" aria-describedby="inputGroupPrepend" required>
                  <div class="invalid-feedback">
