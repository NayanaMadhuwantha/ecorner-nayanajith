...
if (isset ($_POST['name'])  && isset ($_POST['category'])  && isset ($_POST['price'])  && isset($_POST['image']) && isset ($_POST['quantity'])   ) 
  ...
  $sql = 'UPDATE tbl_products SET P_name =:name, P_category =:category, P_price=:price, P_image=:image, P_quantity =:quantity WHERE P_id=:id';
  
  $statement = $connection->prepare($sql);
  
  if ($statement->execute([':name' => $Name,':category' => $Category,':price' => $Price, ':image' => $Image,':quantity' => $Quantity, ':id' => $id]  )) 
  {
        ...
        <form method="post" class="needs-validation" novalidate>
            ...
            <div class="form-row">
              <div class="col-md-6 col-lg-6" style="padding: 1%;">
                ...
                <div class="input-group">
                  <input value="<?= $product->P_name; ?>" type="text" class="form-control" id="validationCustomname" name="name" placeholder="Product Name" aria-describedby="inputGroupPrepend" required>
              ...
              <div class="col-md-6 col-lg-6" style="padding: 1%;">
                ...
                <div class="input-group">
                  <input value="<?= $product->P_category; ?>" type="text" class="form-control" id="validationCustomcategory" name="category" placeholder="Product Category" aria-describedby="inputGroupPrepend" required>
                  <div class="invalid-feedback">
            ...
            <div class="form-row">
              <div class="col-md-6 col-lg-6" style="padding: 1%;">
                ...
                <div class="input-group">
                  <input value="<?= $product->P_price; ?>" type="text" class="form-control" id="validationCustomprice" name="price" placeholder="Product Price" aria-describedby="inputGroupPrepend" required>
                  <div class="invalid-feedback">
              ...
              <div class="col-md-6 col-lg-6" style="padding: 1%;">
                ...
                <div class="input-group">
                  <input value="<?= $product->P_image; ?>" type="text" class="form-control" id="validationCustomimage" name="image" placeholder="Product Image" aria-describedby="inputGroupPrepend" required>
                  <div class="invalid-feedback">
            ...
            <div class="form-row">
              <div class="col-md-6 col-lg-6" style="padding: 1%;">
                ...
                <div class="input-group">
                  <input value="<?= $product->P_quantity; ?>" type="text" class="form-control" id="validationCustomquantity" name="quantity" placeholder="Product Quantity" aria-describedby="inputGroupPrepend" required>
                  <div class="invalid-feedback">
